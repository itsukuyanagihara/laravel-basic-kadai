...
try {
  ...
  // SQLクエリの準備と実行
  $sql = "INSERT INTO arrival_reports (user_id, work_id, arrival_time) VALUES (?, ?, ?)";
...
<head>
  ...
  <title>当日報告フォーム-到着報告</title>
  <link rel="stylesheet" href="../css/style.css">
</head>
<body>
  <!--  -->
  <button class="favorite styled" type="button" onclick="location.href='../home.php'">到着しました</button>
