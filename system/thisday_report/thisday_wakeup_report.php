...
try {
  ...
  // SQLクエリの準備と実行
  $sql = "INSERT INTO wakeup_reports (user_id, work_id, wakeup_time) VALUES (?, ?, ?)";
...
<head>
  ...
  <title>当日報告フォーム-起床報告</title>
</head>
<body>
  <!--  -->
  <button class="favorite styled" type="button" onclick="location.href='thisday_departure_report.php'">起床しました</button>
</body>
</html>